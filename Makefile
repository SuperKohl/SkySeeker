...
VALID_TARGETS	 = ALIENWIIF1 BLUEPILL ALIENWIIF3 CC3D CHEBUZZF3 CJMCU COLIBRI_RACE EUSTM32F103RC MATEKF411SE MOTOLAB NAZE NAZE32PRO OLIMEXINO PORT103R RMDO SPARKY SPRACINGF3 STM32F3DISCOVERY 
...
FLASH_SIZE = 256
else ifeq ($(TARGET),$(filter $(TARGET),MATEKF411SE))
FLASH_SIZE = 512
else
...
MATEKF411SE_SRC = startup_stm32f411xe.S \
		   drivers/accgyro_adxl345.c \
		   drivers/accgyro_bma280.c \
		   drivers/accgyro_l3g4200d.c 
